...
- [ ] Imporve the UI
- [ ] Add a page to view all of the added posts
...
The challenge I encountered while building this app was related to the setup of Parse SDK. I was able to overcome my challenges with the help of codepaths guides.
